...
console.warn(`
Afiseaza suma numerelor de pe pozitiile 0 si 4.
`);
...
console.warn(`
Afiseaza suma numerelor de pe pozitiile 1 si 3.
`);
console.log(myArray[1] + myArray[3]);

console.warn(`
Afiseaza produsul numerelor de pe pozitiile 0 si 5.
`);
console.log(myArray[0] * myArray[5]);

console.warn(`
Afiseaza diferenta numerelor de pe pozitiile 3 si 4.
`);
console.log(myArray[3] - myArray[4]);

console.warn(`
Folosind metoda Math.pow() afla rezultatul ridicarii la putere a numarului de
pe pozitia 5, la numarul de pe pozitia 3
`);
