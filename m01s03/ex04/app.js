...
console.warn(`Afiseaza numarul de pe pozitia/index 5 a arrayului.`);
...
console.warn(`
  Folosind metoda Math.pow() afla rezultatul ridicarii la putere a numarului de pe pozitia 5,
  la numarul de pe pozitia 3
`);
