...
for (var i = 1; i < limitA; i++) {
  ...
  if (i === limitB) {
    console.log('M-am orpit la ' + limitB + '.');
    break;
  }
}
...
32 (inclusiv 32 ) cu propozitii de forma “Toate numele pare intre 1
si 32 inclusiv: i.”.
`);
for (var i = 1; i < limitA; i++) {
  if (i % 2 !== 0) {
...
var twenty = 20;
for (var i = 1; i < limitA; i++) {
  console.log('Numerele pana la ' + twenty + ' inclusiv: ' + i + '.');
...
for (var i = 1; i < limitA; i++) {
  ...
  console.log('Numerele pana la ' + nineteen + ' exclusiv: ' + i + '.');
}
...
var eight = 8;
for (var i = 1; i < limitA; i++) {
  console.log('Numerele se vor opri la ' + eight + ': ' + i + '.');
...
for (var i = 1; i < limitA; i++) {
  if (i <= 20) {
    ...
    console.log('Numerele impare pana la ' + twenty + ' inclusiv: ' + i + '.');
  }
}
...
for (var i = 1; i < limitA; i++) {
  if (i <= 20) {
    if (i % 3 === 0) {
      console.log(
        'Numerele divizibile cu 3 pana la ' + twenty + ' inclusiv: ' + i + '.',
      );
    }
  }
}
